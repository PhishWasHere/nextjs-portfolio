...
export default function Validator (name, email, num, text) {
    try {
        ...
        const fields = [ //need to fix err displays
            ...
            { name: num, value: phoneNumber, err: 'Contact Number (Field Required)', stock: 'Contact Number' },
            { name: text, value: message, err: 'Message (Field Required)', stock: 'Message' },
        ]
    
        const reg = [
            { reg: emailRegex , name: email, value: email, err: 'Email (please enter a valid email)' },
            { reg: numRegex, name: num, value: phoneNumber, err: 'Contact Number (please enter a valid number)' },
        ]
